# Generated by Django 2.1.7 on 2019-05-30 04:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Electronics', 'Electronics'), ('Clothing', 'Clothing'), ('Lifestyle', 'Lifestyle')], max_length=20)),
                ('sub_category', models.CharField(choices=[('T-Shirts', 'T-Shirts'), ('Glasses', 'Glasses'), ('Shoes', 'Shoes'), ('Phone', 'Phone')], max_length=20)),
